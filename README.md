...
For Switch servers, the latest system version that is currently supported is **22.5.0**.
...
### Installation
This package requires Python 3.12 or later and can be installed with pip: `pip install nintendoclients`. This package uses [semantic versioning](https://semver.org/).

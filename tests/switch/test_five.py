...
UNREAD_INVITATION_COUNT_REQUEST = """GET /v1/users/aaaaaaaaaaaaaaaa/invitations/inbox?fields=count&read=false HTTP/1.1
...
GET_INBOX_REQUEST = """GET /v1/users/aaaaaaaaaaaaaaaa/invitations/inbox HTTP/1.1
Host: localhost:12345
User-Agent: libcurl (nnFriends; 789f928b-138e-4b2f-afeb-1acae821d897; SDK 15.3.0.0; Add-on 15.3.0.0)
Accept: */*
Authorization: Bearer access token
...
GET_INVITATION_GROUP_REQUEST = """GET /v1/invitation_groups/12345 HTTP/1.1
Host: localhost:12345
User-Agent: libcurl (nnFriends; 789f928b-138e-4b2f-afeb-1acae821d897; SDK 15.3.0.0; Add-on 15.3.0.0)
Accept: */*
Authorization: Bearer access token
...
MARK_ALL_AS_READ_REQUEST = """PATCH /v1/users/aaaaaaaaaaaaaaaa/invitations/mark_as_read HTTP/1.1
Host: localhost:12345
User-Agent: libcurl (nnFriends; 789f928b-138e-4b2f-afeb-1acae821d897; SDK 15.3.0.0; Add-on 15.3.0.0)
Accept: */*
Authorization: Bearer access token
...
SEND_INVITATION_REQUEST = """POST /v1/invitation_groups HTTP/1.1
Host: localhost:12345
User-Agent: libcurl (nnFriends; 789f928b-138e-4b2f-afeb-1acae821d897; SDK 15.3.0.0; Add-on 15.3.0.0)
Accept: */*
...
async def test_send_invitation(client):
	...
	await client.send_invitation(
		"access token", receivers, title_id, title_id, b"application data", messages
	)

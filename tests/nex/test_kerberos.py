...
def test_key_derivation_old():
	...
	assert keyderiv1.derive_key(b"password", 123456) == bytes.fromhex(
		"bd9d83b0d4102b72de3e14f44938c989"
	)
	assert keyderiv2.derive_key(b"password", 123456) == bytes.fromhex(
		"6ba537f0cc7e0d25813f2ea010eb2115"
	)
...
def test_key_derivation_new():
	...
	assert keyderiv1.derive_key(b"password", 123456) == bytes.fromhex(
		"591b45defe20abcd6ec412b63fbacff5"
	)
	assert keyderiv2.derive_key(b"password", 123456) == bytes.fromhex(
		"09409830bf949ab56fae81bd028fe18d"
	)

...
class DataStoreClientSMM2(DataStoreProtocolSMM2):
	...
	async def prepare_get_object_v1(self, param):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_PREPARE_GET_OBJECT_V1, stream.get()
		)
	...
	async def prepare_post_object_v1(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_PREPARE_POST_OBJECT_V1, stream.get()
		)
	...
	async def complete_post_object_v1(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_COMPLETE_POST_OBJECT_V1, stream.get()
		)
	...
	async def delete_object(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_DELETE_OBJECT, stream.get()
		)
	...
	async def delete_objects(self, param, transactional):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_DELETE_OBJECTS, stream.get()
		)
	...
	async def change_meta_v1(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_CHANGE_META_V1, stream.get()
		)
	...
	async def change_metas_v1(self, data_ids, param, transactional):
		...
		stream.bool(transactional)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_CHANGE_METAS_V1, stream.get()
		)
	...
	async def get_meta(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_META, stream.get()
		)
	...
	async def get_metas(self, data_ids, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_METAS, stream.get()
		)
	...
	async def prepare_update_object(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_PREPARE_UPDATE_OBJECT, stream.get()
		)
	...
	async def complete_update_object(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_COMPLETE_UPDATE_OBJECT, stream.get()
		)
	...
	async def search_object(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_OBJECT, stream.get()
		)
	...
	async def get_notification_url(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_NOTIFICATION_URL, stream.get()
		)
	...
	async def get_new_arrived_notifications_v1(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_NEW_ARRIVED_NOTIFICATIONS_V1, stream.get()
		)
	...
	async def rate_object(self, target, param, fetch_ratings):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_RATE_OBJECT, stream.get()
		)
	...
	async def get_rating(self, target, access_password):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_RATING, stream.get()
		)
	...
	async def get_ratings(self, data_ids, access_password):
		...
		stream.u64(access_password)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_RATINGS, stream.get()
		)
	...
	async def reset_rating(self, target, update_password):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_RESET_RATING, stream.get()
		)
	...
	async def reset_ratings(self, data_ids, transactional):
		...
		stream.bool(transactional)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_RESET_RATINGS, stream.get()
		)
	...
	async def get_specific_meta_v1(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_SPECIFIC_META_V1, stream.get()
		)
	...
	async def post_meta_binary(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_POST_META_BINARY, stream.get()
		)
	...
	async def touch_object(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_TOUCH_OBJECT, stream.get()
		)
	...
	async def get_rating_with_log(self, target, access_password):
		...
		stream.u64(access_password)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_RATING_WITH_LOG, stream.get()
		)
	...
	async def prepare_post_object(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_PREPARE_POST_OBJECT, stream.get()
		)
	...
	async def prepare_get_object(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_PREPARE_GET_OBJECT, stream.get()
		)
	...
	async def complete_post_object(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_COMPLETE_POST_OBJECT, stream.get()
		)
	...
	async def get_new_arrived_notifications(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_NEW_ARRIVED_NOTIFICATIONS, stream.get()
		)
	...
	async def get_specific_meta(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_SPECIFIC_META, stream.get()
		)
	...
	async def get_persistence_info(self, owner_id, slot_id):
		...
		stream.u16(slot_id)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_PERSISTENCE_INFO, stream.get()
		)
	...
	async def get_persistence_infos(self, owner_id, slot_ids):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_PERSISTENCE_INFOS, stream.get()
		)
	...
	async def perpetuate_object(self, persistence_slot_id, data_id, delete_last_object):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_PERPETUATE_OBJECT, stream.get()
		)
	...
	async def unperpetuate_object(self, persistence_slot_id, delete_last_object):
		...
		stream.bool(delete_last_object)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_UNPERPETUATE_OBJECT, stream.get()
		)
	...
	async def prepare_get_object_or_meta_binary(self, param):
		...
		data = await self.client.request(
			self.PROTOCOL_ID,
			self.METHOD_PREPARE_GET_OBJECT_OR_META_BINARY,
			stream.get(),
		)
	...
	async def get_password_info(self, data_id):
		...
		stream.u64(data_id)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_PASSWORD_INFO, stream.get()
		)
	...
	async def get_password_infos(self, data_ids):
		...
		stream.list(data_ids, stream.u64)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_PASSWORD_INFOS, stream.get()
		)
	...
	async def get_metas_multiple_param(self, params):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_METAS_MULTIPLE_PARAM, stream.get()
		)
	...
	async def complete_post_objects(self, data_ids):
		...
		stream.list(data_ids, stream.u64)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_COMPLETE_POST_OBJECTS, stream.get()
		)
	...
	async def change_meta(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_CHANGE_META, stream.get()
		)
	...
	async def change_metas(self, data_ids, param, transactional):
		...
		stream.bool(transactional)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_CHANGE_METAS, stream.get()
		)
	...
	async def rate_objects(self, targets, param, transactional, fetch_ratings):
		...
		stream.bool(fetch_ratings)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_RATE_OBJECTS, stream.get()
		)
	...
	async def post_meta_binary_with_data_id(self, data_id, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_POST_META_BINARY_WITH_DATA_ID, stream.get()
		)
	...
	async def post_meta_binaries_with_data_id(self, data_ids, param, transactional):
		...
		stream.bool(transactional)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_POST_META_BINARIES_WITH_DATA_ID, stream.get()
		)
	...
	async def rate_object_with_posting(
		self, target, rate_param, post_param, fetch_ratings
	):
		...
		stream.bool(fetch_ratings)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_RATE_OBJECT_WITH_POSTING, stream.get()
		)
	...
	async def rate_objects_with_posting(
		self, targets, rate_param, post_param, transactional, fetch_ratings
	):
		...
		stream.bool(fetch_ratings)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_RATE_OBJECTS_WITH_POSTING, stream.get()
		)
	...
	async def get_object_infos(self, data_ids):
		...
		stream.list(data_ids, stream.u64)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_OBJECT_INFOS, stream.get()
		)
	...
	async def search_object_light(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_OBJECT_LIGHT, stream.get()
		)
	...
	async def register_user(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_REGISTER_USER, stream.get()
		)
	...
	async def get_users(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_USERS, stream.get()
		)
	...
	async def sync_user_profile(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SYNC_USER_PROFILE, stream.get()
		)
	...
	async def search_users_user_point(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_USERS_USER_POINT, stream.get()
		)
	...
	async def search_users_played_course(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_USERS_PLAYED_COURSE, stream.get()
		)
	...
	async def search_users_cleared_course(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_USERS_CLEARED_COURSE, stream.get()
		)
	...
	async def search_users_positive_rated_course(self, param):
		...
		data = await self.client.request(
			self.PROTOCOL_ID,
			self.METHOD_SEARCH_USERS_POSITIVE_RATED_COURSE,
			stream.get(),
		)
	...
	async def update_last_login_time(self):
		...
		stream = streams.StreamOut(self.settings)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_UPDATE_LAST_LOGIN_TIME, stream.get()
		)
	...
	async def get_username_ng_type(self):
		...
		stream = streams.StreamOut(self.settings)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_USERNAME_NG_TYPE, stream.get()
		)
	...
	async def get_courses(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_COURSES, stream.get()
		)
	...
	async def search_courses_point_ranking(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_COURSES_POINT_RANKING, stream.get()
		)
	...
	async def search_courses_latest(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_COURSES_LATEST, stream.get()
		)
	...
	async def search_courses_posted_by(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_COURSES_POSTED_BY, stream.get()
		)
	...
	async def search_courses_positive_rated_by(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_COURSES_POSITIVE_RATED_BY, stream.get()
		)
	...
	async def search_courses_played_by(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_COURSES_PLAYED_BY, stream.get()
		)
	...
	async def search_courses_endless_mode(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_COURSES_ENDLESS_MODE, stream.get()
		)
	...
	async def search_courses_first_clear(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_COURSES_FIRST_CLEAR, stream.get()
		)
	...
	async def search_courses_best_time(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_COURSES_BEST_TIME, stream.get()
		)
	...
	async def get_courses_event(self, param, dummy):
		...
		stream.add(dummy)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_COURSES_EVENT, stream.get()
		)
	...
	async def search_courses_event(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_COURSES_EVENT, stream.get()
		)
	...
	async def search_comments_in_order(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_COMMENTS_IN_ORDER, stream.get()
		)
	...
	async def search_comments(self, data_id):
		...
		stream.u64(data_id)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_COMMENTS, stream.get()
		)
	...
	async def get_death_positions(self, data_id):
		...
		stream.u64(data_id)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_DEATH_POSITIONS, stream.get()
		)
	...
	async def get_user_or_course(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_USER_OR_COURSE, stream.get()
		)
	...
	async def get_req_get_info_headers_info(self, type):
		...
		stream.u8(type)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_REQ_GET_INFO_HEADERS_INFO, stream.get()
		)
	...
	async def get_event_course_stamp(self):
		...
		stream = streams.StreamOut(self.settings)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_EVENT_COURSE_STAMP, stream.get()
		)
	...
	async def get_event_course_status(self):
		...
		stream = streams.StreamOut(self.settings)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_EVENT_COURSE_STATUS, stream.get()
		)
	...
	async def get_event_course_histogram(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_EVENT_COURSE_HISTOGRAM, stream.get()
		)
	...
	async def get_event_course_ghost(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_EVENT_COURSE_GHOST, stream.get()
		)
	...
	async def get_world_map(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_WORLD_MAP, stream.get()
		)
	...
	async def search_world_map_pick_up(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_WORLD_MAP_PICK_UP, stream.get()
		)
...
class DataStoreServerSMM2(DataStoreProtocolSMM2):
	...
	async def handle(self, client, method_id, input, output):
		if method_id in self.methods:
			...
			logger.warning(
				"Unknown method called on DataStoreServerSMM2: %i", method_id
			)
	...
	async def handle_prepare_get_object_v1(self, client, input, output):
		...
		if not isinstance(response, DataStoreReqGetInfoV1):
			raise RuntimeError(
				"Expected DataStoreReqGetInfoV1, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def handle_prepare_post_object_v1(self, client, input, output):
		...
		if not isinstance(response, DataStoreReqPostInfoV1):
			raise RuntimeError(
				"Expected DataStoreReqPostInfoV1, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def handle_get_meta(self, client, input, output):
		...
		if not isinstance(response, DataStoreMetaInfo):
			raise RuntimeError(
				"Expected DataStoreMetaInfo, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def handle_prepare_update_object(self, client, input, output):
		...
		if not isinstance(response, DataStoreReqUpdateInfo):
			raise RuntimeError(
				"Expected DataStoreReqUpdateInfo, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def handle_search_object(self, client, input, output):
		...
		if not isinstance(response, DataStoreSearchResult):
			raise RuntimeError(
				"Expected DataStoreSearchResult, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def handle_get_notification_url(self, client, input, output):
		...
		if not isinstance(response, DataStoreReqGetNotificationUrlInfo):
			raise RuntimeError(
				"Expected DataStoreReqGetNotificationUrlInfo, got %s"
	...
	async def handle_rate_object(self, client, input, output):
		...
		if not isinstance(response, DataStoreRatingInfo):
			raise RuntimeError(
				"Expected DataStoreRatingInfo, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def handle_prepare_post_object(self, client, input, output):
		...
		if not isinstance(response, DataStoreReqPostInfo):
			raise RuntimeError(
				"Expected DataStoreReqPostInfo, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def handle_prepare_get_object(self, client, input, output):
		...
		if not isinstance(response, DataStoreReqGetInfo):
			raise RuntimeError(
				"Expected DataStoreReqGetInfo, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def handle_get_persistence_info(self, client, input, output):
		...
		if not isinstance(response, DataStorePersistenceInfo):
			raise RuntimeError(
				"Expected DataStorePersistenceInfo, got %s"
				% response.__class__.__name__
			)
		output.add(response)
	...
	async def handle_perpetuate_object(self, client, input, output):
		...
		await self.perpetuate_object(
			client, persistence_slot_id, data_id, delete_last_object
		)
	...
	async def handle_get_password_info(self, client, input, output):
		...
		if not isinstance(response, DataStorePasswordInfo):
			raise RuntimeError(
				"Expected DataStorePasswordInfo, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def handle_rate_objects(self, client, input, output):
		...
		transactional = input.bool()
		fetch_ratings = input.bool()
		response = await self.rate_objects(
			client, targets, param, transactional, fetch_ratings
		)
	...
	async def handle_post_meta_binaries_with_data_id(self, client, input, output):
		...
		response = await self.post_meta_binaries_with_data_id(
			client, data_ids, param, transactional
		)
	...
	async def handle_rate_object_with_posting(self, client, input, output):
		...
		response = await self.rate_object_with_posting(
			client, target, rate_param, post_param, fetch_ratings
		)
	...
	async def handle_rate_objects_with_posting(self, client, input, output):
		...
		transactional = input.bool()
		fetch_ratings = input.bool()
		response = await self.rate_objects_with_posting(
			client, targets, rate_param, post_param, transactional, fetch_ratings
		)
	...
	async def handle_sync_user_profile(self, client, input, output):
		...
		if not isinstance(response, SyncUserProfileResult):
			raise RuntimeError(
				"Expected SyncUserProfileResult, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def handle_get_req_get_info_headers_info(self, client, input, output):
		...
		if not isinstance(response, ReqGetInfoHeadersInfo):
			raise RuntimeError(
				"Expected ReqGetInfoHeadersInfo, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def handle_get_event_course_status(self, client, input, output):
		...
		if not isinstance(response, EventCourseStatusInfo):
			raise RuntimeError(
				"Expected EventCourseStatusInfo, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def handle_get_event_course_histogram(self, client, input, output):
		...
		if not isinstance(response, EventCourseHistogram):
			raise RuntimeError(
				"Expected EventCourseHistogram, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def get_new_arrived_notifications_v1(self, *args):
		logger.warning(
			"DataStoreServerSMM2.get_new_arrived_notifications_v1 not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def get_new_arrived_notifications(self, *args):
		logger.warning(
			"DataStoreServerSMM2.get_new_arrived_notifications not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def prepare_get_object_or_meta_binary(self, *args):
		logger.warning(
			"DataStoreServerSMM2.prepare_get_object_or_meta_binary not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def post_meta_binary_with_data_id(self, *args):
		logger.warning(
			"DataStoreServerSMM2.post_meta_binary_with_data_id not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def post_meta_binaries_with_data_id(self, *args):
		logger.warning(
			"DataStoreServerSMM2.post_meta_binaries_with_data_id not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def search_users_cleared_course(self, *args):
		logger.warning(
			"DataStoreServerSMM2.search_users_cleared_course not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def search_users_positive_rated_course(self, *args):
		logger.warning(
			"DataStoreServerSMM2.search_users_positive_rated_course not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def search_courses_point_ranking(self, *args):
		logger.warning(
			"DataStoreServerSMM2.search_courses_point_ranking not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def search_courses_positive_rated_by(self, *args):
		logger.warning(
			"DataStoreServerSMM2.search_courses_positive_rated_by not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def search_courses_endless_mode(self, *args):
		logger.warning(
			"DataStoreServerSMM2.search_courses_endless_mode not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def get_req_get_info_headers_info(self, *args):
		logger.warning(
			"DataStoreServerSMM2.get_req_get_info_headers_info not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

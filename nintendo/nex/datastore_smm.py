...
class DataStoreClientSMM(DataStoreProtocolSMM):
	...
	async def get_application_config(self, id):
		...
		stream.u32(id)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_APPLICATION_CONFIG, stream.get()
		)
	...
	async def get_application_config_string(self, id):
		...
		stream.u32(id)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_APPLICATION_CONFIG_STRING, stream.get()
		)
...
class DataStoreServerSMM(DataStoreProtocolSMM):
	...
	async def get_new_arrived_notifications_v1(self, *args):
		logger.warning(
			"DataStoreServerSMM.get_new_arrived_notifications_v1 not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def get_new_arrived_notifications(self, *args):
		logger.warning(
			"DataStoreServerSMM.get_new_arrived_notifications not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def prepare_get_object_or_meta_binary(self, *args):
		logger.warning(
			"DataStoreServerSMM.prepare_get_object_or_meta_binary not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def post_meta_binary_with_data_id(self, *args):
		logger.warning(
			"DataStoreServerSMM.post_meta_binary_with_data_id not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def post_meta_binaries_with_data_id(self, *args):
		logger.warning(
			"DataStoreServerSMM.post_meta_binaries_with_data_id not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def get_application_config_string(self, *args):
		logger.warning(
			"DataStoreServerSMM.get_application_config_string not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

		...
		if settings["nex.version"] >= 40000:
			if version >= 1:
				for field in ["unk3", "unk4"]:
					if getattr(self, field) is None:
						raise ValueError(
							"No value assigned to required field: %s" % field
						)
...
class MatchmakeExtensionClientMK8D(MatchmakeExtensionProtocolMK8D):
	...
	async def browse_matchmake_session_with_host_urls(self, search_criteria, range):
		logger.info(
			"MatchmakeExtensionClientMK8D.browse_matchmake_session_with_host_urls()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.add(search_criteria)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.browse_matchmake_session_with_host_urls -> done"
		)
		return obj
	...
	async def modify_current_game_attribute(self, gid, attrib, value):
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.modify_current_game_attribute -> done"
		)
	...
	async def update_matchmake_session_attribute(self, gid, attribs):
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.update_matchmake_session_attribute -> done"
		)
	...
	async def get_friend_notification_data_list(self, types):
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.get_friend_notification_data_list -> done"
		)
		return notifications
	...
	async def auto_matchmake_with_search_criteria_postpone(
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.auto_matchmake_with_search_criteria_postpone()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.auto_matchmake_with_search_criteria_postpone -> done"
		)
		return gathering
	...
	async def find_community_by_gathering_id(self, gids):
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.find_community_by_gathering_id -> done"
		)
		return communities
	...
	async def find_community_by_participant(self, pid, range):
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.find_community_by_participant -> done"
		)
		return communities
	...
	async def auto_matchmake_with_gathering_id_postpone(self, gids, gathering, message):
		logger.info(
			"MatchmakeExtensionClientMK8D.auto_matchmake_with_gathering_id_postpone()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.list(gids, stream.u32)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.auto_matchmake_with_gathering_id_postpone -> done"
		)
	...
	async def generate_matchmake_session_system_password(self, gid):
		logger.info(
			"MatchmakeExtensionClientMK8D.generate_matchmake_session_system_password()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.u32(gid)
		data = await self.client.request(
			self.PROTOCOL_ID,
			self.METHOD_GENERATE_MATCHMAKE_SESSION_SYSTEM_PASSWORD,
			stream.get(),
		)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.generate_matchmake_session_system_password -> done"
		)
		return password

	async def clear_matchmake_session_system_password(self, gid):
		logger.info(
			"MatchmakeExtensionClientMK8D.clear_matchmake_session_system_password()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.u32(gid)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.clear_matchmake_session_system_password -> done"
		)

	async def create_matchmake_session_with_param(self, param):
		logger.info(
			"MatchmakeExtensionClientMK8D.create_matchmake_session_with_param()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.add(param)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.create_matchmake_session_with_param -> done"
		)
		return session
	...
	async def join_matchmake_session_with_param(self, param):
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.join_matchmake_session_with_param -> done"
		)
		return session
	...
	async def auto_matchmake_with_param_postpone(self, param):
		...
		data = await self.client.request(
			self.PROTOCOL_ID,
			self.METHOD_AUTO_MATCHMAKE_WITH_PARAM_POSTPONE,
			stream.get(),
		)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.auto_matchmake_with_param_postpone -> done"
		)
		return session

	async def find_matchmake_session_by_gathering_id_detail(self, gid):
		logger.info(
			"MatchmakeExtensionClientMK8D.find_matchmake_session_by_gathering_id_detail()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.u32(gid)
		data = await self.client.request(
			self.PROTOCOL_ID,
			self.METHOD_FIND_MATCHMAKE_SESSION_BY_GATHERING_ID_DETAIL,
			stream.get(),
		)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.find_matchmake_session_by_gathering_id_detail -> done"
		)
		return session
	...
	async def browse_matchmake_session_no_holder(self, search_criteria, range):
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.browse_matchmake_session_no_holder -> done"
		)
		return sessions
	...
	async def browse_matchmake_session_with_host_urls_no_holder(
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.browse_matchmake_session_with_host_urls_no_holder()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.add(search_criteria)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.browse_matchmake_session_with_host_urls_no_holder -> done"
		)
		return obj
	...
	async def update_matchmake_session_part(self, param):
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.update_matchmake_session_part -> done"
		)
	...
	async def find_matchmake_session_by_gathering_id(self, gids):
		logger.info(
			"MatchmakeExtensionClientMK8D.find_matchmake_session_by_gathering_id()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.list(gids, stream.u32)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.find_matchmake_session_by_gathering_id -> done"
		)
		return sessions

	async def find_matchmake_session_by_single_gathering_id(self, gid):
		logger.info(
			"MatchmakeExtensionClientMK8D.find_matchmake_session_by_single_gathering_id()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.u32(gid)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.find_matchmake_session_by_single_gathering_id -> done"
		)
		return session
	...
	async def find_matchmake_session_by_owner(self, pid, range):
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.find_matchmake_session_by_owner -> done"
		)
		return sessions

	async def find_matchmake_session_by_participant(self, param):
		logger.info(
			"MatchmakeExtensionClientMK8D.find_matchmake_session_by_participant()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.add(param)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.find_matchmake_session_by_participant -> done"
		)
		return result

	async def browse_matchmake_session_no_holder_no_result_range(self, search_criteria):
		logger.info(
			"MatchmakeExtensionClientMK8D.browse_matchmake_session_no_holder_no_result_range()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.add(search_criteria)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.browse_matchmake_session_no_holder_no_result_range -> done"
		)
		return sessions
	...
	async def browse_matchmake_session_with_host_urls_no_holder_no_result_range(
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.browse_matchmake_session_with_host_urls_no_holder_no_result_range()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.add(search_criteria)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.browse_matchmake_session_with_host_urls_no_holder_no_result_range -> done"
		)
		return obj
	...
	async def search_simple_search_object_by_object_ids(self, ids):
		logger.info(
			"MatchmakeExtensionClientMK8D.search_simple_search_object_by_object_ids()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.list(ids, stream.u32)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.search_simple_search_object_by_object_ids -> done"
		)
		return objects
	...
	async def join_matchmake_session_with_extra_participants(
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.join_matchmake_session_with_extra_participants()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.u32(gid)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.join_matchmake_session_with_extra_participants -> done"
		)
		return session_key
	...
	async def create_competition(self, competition):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_CREATE_COMPETITION, stream.get()
		)
	...
	async def delete_competition(self, id):
		...
		stream.u32(id)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_DELETE_COMPETITION, stream.get()
		)
	...
	async def register_favorite_competition(self, id):
		...
		stream.u32(id)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_REGISTER_FAVORITE_COMPETITION, stream.get()
		)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.register_favorite_competition -> done"
		)
	...
	async def unregister_favorite_competition(self, id):
		...
		stream.u32(id)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_UNREGISTER_FAVORITE_COMPETITION, stream.get()
		)
		...
		logger.info(
			"MatchmakeExtensionClientMK8D.unregister_favorite_competition -> done"
		)
	...
	async def get_favorite_competition(self):
		...
		stream = streams.StreamOut(self.settings)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_FAVORITE_COMPETITION, stream.get()
		)
...
class MatchmakeExtensionServerMK8D(MatchmakeExtensionProtocolMK8D):
	...
	async def handle(self, client, method_id, input, output):
		if method_id in self.methods:
			...
			logger.warning(
				"Unknown method called on MatchmakeExtensionServerMK8D: %i", method_id
			)
			raise common.RMCError("Core::NotImplemented")
	...
	async def handle_browse_matchmake_session_with_host_urls(
		...
		logger.info(
			"MatchmakeExtensionServerMK8D.browse_matchmake_session_with_host_urls()"
		)
		# --- request ---
		search_criteria = input.extract(MatchmakeSessionSearchCriteria)
		range = input.extract(common.ResultRange)
	...
	async def handle_auto_matchmake_with_search_criteria_postpone(
		...
		logger.info(
			"MatchmakeExtensionServerMK8D.auto_matchmake_with_search_criteria_postpone()"
		)
		# --- request ---
	...
	async def handle_auto_matchmake_with_gathering_id_postpone(
		...
		logger.info(
			"MatchmakeExtensionServerMK8D.auto_matchmake_with_gathering_id_postpone()"
		)
		# --- request ---
		gids = input.list(input.u32)
		gathering = input.anydata()
	...
	async def handle_generate_matchmake_session_system_password(
		self, client, input, output
	):
		logger.info(
			"MatchmakeExtensionServerMK8D.generate_matchmake_session_system_password()"
		)
		# --- request ---
		gid = input.u32()
	...
	async def handle_clear_matchmake_session_system_password(
		self, client, input, output
	):
		logger.info(
			"MatchmakeExtensionServerMK8D.clear_matchmake_session_system_password()"
		)
		# --- request ---
		gid = input.u32()
	...
	async def handle_create_matchmake_session_with_param(self, client, input, output):
		logger.info(
			"MatchmakeExtensionServerMK8D.create_matchmake_session_with_param()"
		)
		# --- request ---
	...
	async def handle_find_matchmake_session_by_gathering_id_detail(
		self, client, input, output
	):
		logger.info(
			"MatchmakeExtensionServerMK8D.find_matchmake_session_by_gathering_id_detail()"
		)
		# --- request ---
		gid = input.u32()
	...
	async def handle_browse_matchmake_session_with_host_urls_no_holder(
		...
		logger.info(
			"MatchmakeExtensionServerMK8D.browse_matchmake_session_with_host_urls_no_holder()"
		)
		# --- request ---
		search_criteria = input.extract(MatchmakeSessionSearchCriteria)
		range = input.extract(common.ResultRange)
	...
	async def handle_find_matchmake_session_by_gathering_id(
		...
		logger.info(
			"MatchmakeExtensionServerMK8D.find_matchmake_session_by_gathering_id()"
		)
		# --- request ---
		gids = input.list(input.u32)
	...
	async def handle_find_matchmake_session_by_single_gathering_id(
		...
		logger.info(
			"MatchmakeExtensionServerMK8D.find_matchmake_session_by_single_gathering_id()"
		)
		# --- request ---
		gid = input.u32()
	...
	async def handle_find_matchmake_session_by_participant(self, client, input, output):
		logger.info(
			"MatchmakeExtensionServerMK8D.find_matchmake_session_by_participant()"
		)
		# --- request ---
	...
	async def handle_browse_matchmake_session_no_holder_no_result_range(
		...
		logger.info(
			"MatchmakeExtensionServerMK8D.browse_matchmake_session_no_holder_no_result_range()"
		)
		# --- request ---
		search_criteria = input.extract(MatchmakeSessionSearchCriteria)
	...
	async def handle_browse_matchmake_session_with_host_urls_no_holder_no_result_range(
		...
		logger.info(
			"MatchmakeExtensionServerMK8D.browse_matchmake_session_with_host_urls_no_holder_no_result_range()"
		)
		# --- request ---
		search_criteria = input.extract(MatchmakeSessionSearchCriteria)
	...
	async def handle_search_simple_search_object_by_object_ids(
		...
		logger.info(
			"MatchmakeExtensionServerMK8D.search_simple_search_object_by_object_ids()"
		)
		# --- request ---
		ids = input.list(input.u32)
	...
	async def handle_join_matchmake_session_with_extra_participants(
		...
		logger.info(
			"MatchmakeExtensionServerMK8D.join_matchmake_session_with_extra_participants()"
		)
		# --- request ---
		gid = input.u32()
	...
	async def handle_custom_get_simple_playing_session(self, client, input, output):
		logger.warning(
			"MatchmakeExtensionServerMK8D.custom_get_simple_playing_session is not supported"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def handle_create_competition(self, client, input, output):
		...
		if not isinstance(response, SimpleSearchObject):
			raise RuntimeError(
				"Expected SimpleSearchObject, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def handle_get_team_participants(self, client, input, output):
		logger.warning(
			"MatchmakeExtensionServerMK8D.get_team_participants is not supported"
		)
		raise common.RMCError("Core::NotImplemented")

	async def handle_find_community_by_owner(self, client, input, output):
		logger.warning(
			"MatchmakeExtensionServerMK8D.find_community_by_owner is not supported"
		)
		raise common.RMCError("Core::NotImplemented")

	async def close_participation(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.close_participation not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def open_participation(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.open_participation not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def auto_matchmake_postpone(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.auto_matchmake_postpone not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def browse_matchmake_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.browse_matchmake_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def browse_matchmake_session_with_host_urls(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.browse_matchmake_session_with_host_urls not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def create_matchmake_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.create_matchmake_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def join_matchmake_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.join_matchmake_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def modify_current_game_attribute(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.modify_current_game_attribute not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_notification_data(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.update_notification_data not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_friend_notification_data(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.get_friend_notification_data not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_application_buffer(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.update_application_buffer not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_matchmake_session_attribute(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.update_matchmake_session_attribute not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_friend_notification_data_list(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.get_friend_notification_data_list not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_matchmake_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.update_matchmake_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def auto_matchmake_with_search_criteria_postpone(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.auto_matchmake_with_search_criteria_postpone not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_playing_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.get_playing_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def find_community_by_gathering_id(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.find_community_by_gathering_id not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_official_community(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.find_official_community not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_community_by_participant(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.find_community_by_participant not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_privacy_setting(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.update_privacy_setting not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def remove_from_block_list(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.remove_from_block_list not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def clear_my_block_list(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.clear_my_block_list not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def join_matchmake_session_ex(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.join_matchmake_session_ex not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_simple_playing_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.get_simple_playing_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_simple_community(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.get_simple_community not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def auto_matchmake_with_gathering_id_postpone(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.auto_matchmake_with_gathering_id_postpone not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_progress_score(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.update_progress_score not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def debug_notify_event(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.debug_notify_event not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def generate_matchmake_session_system_password(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.generate_matchmake_session_system_password not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def clear_matchmake_session_system_password(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.clear_matchmake_session_system_password not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def create_matchmake_session_with_param(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.create_matchmake_session_with_param not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def join_matchmake_session_with_param(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.join_matchmake_session_with_param not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def auto_matchmake_with_param_postpone(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.auto_matchmake_with_param_postpone not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_matchmake_session_by_gathering_id_detail(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.find_matchmake_session_by_gathering_id_detail not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def browse_matchmake_session_no_holder(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.browse_matchmake_session_no_holder not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def browse_matchmake_session_with_host_urls_no_holder(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.browse_matchmake_session_with_host_urls_no_holder not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_matchmake_session_part(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.update_matchmake_session_part not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def request_matchmaking(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.request_matchmaking not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def withdraw_matchmaking(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.withdraw_matchmaking not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def withdraw_matchmaking_all(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.withdraw_matchmaking_all not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_matchmake_session_by_gathering_id(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.find_matchmake_session_by_gathering_id not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_matchmake_session_by_single_gathering_id(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.find_matchmake_session_by_single_gathering_id not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_matchmake_session_by_owner(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.find_matchmake_session_by_owner not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_matchmake_session_by_participant(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.find_matchmake_session_by_participant not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def browse_matchmake_session_no_holder_no_result_range(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.browse_matchmake_session_no_holder_no_result_range not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def browse_matchmake_session_with_host_urls_no_holder_no_result_range(
		...
		logger.warning(
			"MatchmakeExtensionServerMK8D.browse_matchmake_session_with_host_urls_no_holder_no_result_range not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def create_simple_search_object(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.create_simple_search_object not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_simple_search_object(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.update_simple_search_object not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def delete_simple_search_object(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.delete_simple_search_object not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def search_simple_search_object(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.search_simple_search_object not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def search_simple_search_object_by_object_ids(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.search_simple_search_object_by_object_ids not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def join_matchmake_session_with_extra_participants(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.join_matchmake_session_with_extra_participants not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def create_competition(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.create_competition not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def delete_competition(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.delete_competition not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def register_favorite_competition(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.register_favorite_competition not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def unregister_favorite_competition(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.unregister_favorite_competition not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_favorite_competition(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMK8D.get_favorite_competition not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

...
class FriendsClientV1(FriendsProtocolV1):
	...
	async def update_profile(self, profile_data):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_UPDATE_PROFILE, stream.get()
		)
	...
	async def update_mii(self, mii):
		...
		stream.add(mii)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_UPDATE_MII, stream.get()
		)
	...
	async def update_mii_list(self, mii_list):
		...
		stream.add(mii_list)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_UPDATE_MII_LIST, stream.get()
		)
	...
	async def update_played_games(self, played_games):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_UPDATE_PLAYED_GAMES, stream.get()
		)
	...
	async def update_preference(
		self, show_online_status, show_current_title, block_friend_requests
	):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_UPDATE_PREFERENCE, stream.get()
		)
	...
	async def get_friend_mii(self, friends):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_FRIEND_MII, stream.get()
		)
	...
	async def get_friend_mii_list(self, friends):
		...
		stream.list(friends, stream.add)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_FRIEND_MII_LIST, stream.get()
		)
	...
	async def is_active_game(self, unk1, game_key):
		...
		stream.add(game_key)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_IS_ACTIVE_GAME, stream.get()
		)
	...
	async def get_principal_id_by_local_friend_code(self, unk1, unk2):
		...
		data = await self.client.request(
			self.PROTOCOL_ID,
			self.METHOD_GET_PRINCIPAL_ID_BY_LOCAL_FRIEND_CODE,
			stream.get(),
		)
	...
	async def get_friend_relationships(self, principal_ids):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_FRIEND_RELATIONSHIPS, stream.get()
		)
	...
	async def add_friend_by_principal_id(self, friend_seed, pid):
		...
		stream.pid(pid)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_ADD_FRIEND_BY_PRINCIPAL_ID, stream.get()
		)
	...
	async def add_friend_by_principal_ids(self, unk, pids):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_ADD_FRIEND_BY_PRINCIPAL_IDS, stream.get()
		)
	...
	async def remove_friend_by_local_friend_code(self, friend_code):
		...
		data = await self.client.request(
			self.PROTOCOL_ID,
			self.METHOD_REMOVE_FRIEND_BY_LOCAL_FRIEND_CODE,
			stream.get(),
		)
	...
	async def remove_friend_by_principal_id(self, pid):
		...
		stream.pid(pid)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_REMOVE_FRIEND_BY_PRINCIPAL_ID, stream.get()
		)
	...
	async def get_all_friends(self):
		...
		stream = streams.StreamOut(self.settings)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_ALL_FRIENDS, stream.get()
		)
	...
	async def update_black_list(self, unk):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_UPDATE_BLACK_LIST, stream.get()
		)
	...
	async def sync_friend(self, friend_seed, principal_ids, unk):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SYNC_FRIEND, stream.get()
		)
	...
	async def update_presence(self, presence_info, unk):
		...
		stream.bool(unk)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_UPDATE_PRESENCE, stream.get()
		)
	...
	async def update_favorite_game_key(self, game_key):
		...
		stream.add(game_key)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_UPDATE_FAVORITE_GAME_KEY, stream.get()
		)
	...
	async def update_comment(self, comment):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_UPDATE_COMMENT, stream.get()
		)
	...
	async def update_picture(self, unk, picture):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_UPDATE_PICTURE, stream.get()
		)
	...
	async def get_friend_presence(self, principal_ids):
		...
		stream.list(principal_ids, stream.pid)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_FRIEND_PRESENCE, stream.get()
		)
	...
	async def get_friend_comment(self, friends):
		...
		stream.list(friends, stream.add)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_FRIEND_COMMENT, stream.get()
		)
	...
	async def get_friend_picture(self, principal_ids):
		...
		stream.list(principal_ids, stream.pid)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_FRIEND_PICTURE, stream.get()
		)
	...
	async def get_friend_persistent_info(self, principal_ids):
		...
		stream.list(principal_ids, stream.pid)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_FRIEND_PERSISTENT_INFO, stream.get()
		)
	...
	async def send_invitation(self, unk):
		...
		stream.list(unk, stream.u32)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEND_INVITATION, stream.get()
		)
...
class FriendsClientV2(FriendsProtocolV2):
	...
	async def update_and_get_all_information(self, nna_info, presence, birthday):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_UPDATE_AND_GET_ALL_INFORMATION, stream.get()
		)
	...
	async def add_friend(self, pid):
		...
		stream.pid(pid)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_ADD_FRIEND, stream.get()
		)
	...
	async def add_friend_by_name(self, name):
		...
		stream.string(name)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_ADD_FRIEND_BY_NAME, stream.get()
		)
	...
	async def add_friend_request(self, unk1, unk2, unk3, unk4, unk5, game_key, unk6):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_ADD_FRIEND_REQUEST, stream.get()
		)
	...
	async def cancel_friend_request(self, id):
		...
		stream.u64(id)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_CANCEL_FRIEND_REQUEST, stream.get()
		)
	...
	async def accept_friend_request(self, id):
		...
		stream.u64(id)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_ACCEPT_FRIEND_REQUEST, stream.get()
		)
	...
	async def delete_friend_request(self, id):
		...
		stream.u64(id)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_DELETE_FRIEND_REQUEST, stream.get()
		)
	...
	async def deny_friend_request(self, id):
		...
		stream.u64(id)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_DENY_FRIEND_REQUEST, stream.get()
		)
	...
	async def mark_friend_requests_as_received(self, ids):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_MARK_FRIEND_REQUESTS_AS_RECEIVED, stream.get()
		)
	...
	async def add_black_list(self, principal):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_ADD_BLACK_LIST, stream.get()
		)
	...
	async def remove_black_list(self, pid):
		...
		stream.pid(pid)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_REMOVE_BLACK_LIST, stream.get()
		)
	...
	async def get_basic_info(self, pids):
		...
		stream.list(pids, stream.pid)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_BASIC_INFO, stream.get()
		)
	...
	async def delete_persistent_notification(self, notifications):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_DELETE_PERSISTENT_NOTIFICATION, stream.get()
		)
	...
	async def check_setting_status(self):
		...
		stream = streams.StreamOut(self.settings)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_CHECK_SETTING_STATUS, stream.get()
		)
	...
	async def get_request_block_settings(self, unk):
		...
		stream.list(unk, stream.u32)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_REQUEST_BLOCK_SETTINGS, stream.get()
		)
...
class FriendsServerV1(FriendsProtocolV1):
	...
	async def handle_update_preference(self, client, input, output):
		...
		await self.update_preference(
			client, show_online_status, show_current_title, block_friend_requests
		)
	...
	async def handle_add_friend_by_principal_id(self, client, input, output):
		...
		if not isinstance(response, FriendRelationship):
			raise RuntimeError(
				"Expected FriendRelationship, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def get_principal_id_by_local_friend_code(self, *args):
		logger.warning(
			"FriendsServerV1.get_principal_id_by_local_friend_code not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def remove_friend_by_local_friend_code(self, *args):
		logger.warning(
			"FriendsServerV1.remove_friend_by_local_friend_code not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
...
class FriendsServerV2(FriendsProtocolV2):
	...
	async def handle_update_and_get_all_information(self, client, input, output):
		...
		response = await self.update_and_get_all_information(
			client, nna_info, presence, birthday
		)
	...
	async def handle_add_friend_request(self, client, input, output):
		...
		game_key = input.extract(GameKey)
		unk6 = input.datetime()
		response = await self.add_friend_request(
			client, unk1, unk2, unk3, unk4, unk5, game_key, unk6
		)
	...
	async def handle_accept_friend_request(self, client, input, output):
		...
		if not isinstance(response, FriendInfo):
			raise RuntimeError(
				"Expected FriendInfo, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def handle_deny_friend_request(self, client, input, output):
		...
		if not isinstance(response, BlacklistedPrincipal):
			raise RuntimeError(
				"Expected BlacklistedPrincipal, got %s" % response.__class__.__name__
			)
		output.add(response)
	...
	async def handle_update_mii(self, client, input, output):
		...
		if not isinstance(response, common.DateTime):
			raise RuntimeError(
				"Expected common.DateTime, got %s" % response.__class__.__name__
			)
	...
	async def mark_friend_requests_as_received(self, *args):
		logger.warning(
			"FriendsServerV2.mark_friend_requests_as_received not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

...
class DataStoreClientMiitopia3DS(DataStoreProtocolMiitopia3DS):
	...
	async def get_new_arrived_notifications_v1(self, param):
		...
		logger.info(
			"DataStoreClientMiitopia3DS.get_new_arrived_notifications_v1 -> done"
		)
		return obj
	...
	async def prepare_get_object_or_meta_binary(self, param):
		...
		logger.info(
			"DataStoreClientMiitopia3DS.prepare_get_object_or_meta_binary -> done"
		)
		return obj
	...
	async def post_meta_binaries_with_data_id(self, data_ids, param, transactional):
		...
		logger.info(
			"DataStoreClientMiitopia3DS.post_meta_binaries_with_data_id -> done"
		)
		return results
	...
	async def search_mii(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_SEARCH_MII, stream.get()
		)
...
class DataStoreServerMiitopia3DS(DataStoreProtocolMiitopia3DS):
	...
	async def handle(self, client, method_id, input, output):
		if method_id in self.methods:
			...
			logger.warning(
				"Unknown method called on DataStoreServerMiitopia3DS: %i", method_id
			)
	...
	async def handle_search_mii(self, client, input, output):
		...
		if not isinstance(response, MiiTubeSearchResult):
			raise RuntimeError(
				"Expected MiiTubeSearchResult, got %s" % response.__class__.__name__
			)
		output.add(response)

	async def prepare_get_object_v1(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.prepare_get_object_v1 not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def prepare_post_object_v1(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.prepare_post_object_v1 not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def complete_post_object_v1(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.complete_post_object_v1 not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def prepare_update_object(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.prepare_update_object not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def complete_update_object(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.complete_update_object not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def get_notification_url(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.get_notification_url not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_new_arrived_notifications_v1(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.get_new_arrived_notifications_v1 not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def get_specific_meta_v1(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.get_specific_meta_v1 not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def complete_post_object(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.complete_post_object not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_new_arrived_notifications(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.get_new_arrived_notifications not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def get_persistence_info(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.get_persistence_info not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_persistence_infos(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.get_persistence_infos not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def prepare_get_object_or_meta_binary(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.prepare_get_object_or_meta_binary not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def get_metas_multiple_param(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.get_metas_multiple_param not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def complete_post_objects(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.complete_post_objects not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def post_meta_binary_with_data_id(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.post_meta_binary_with_data_id not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def post_meta_binaries_with_data_id(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.post_meta_binaries_with_data_id not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def rate_object_with_posting(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.rate_object_with_posting not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def rate_objects_with_posting(self, *args):
		logger.warning(
			"DataStoreServerMiitopia3DS.rate_objects_with_posting not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

...
class MatchmakeExtensionClient(MatchmakeExtensionProtocol):
	...
	async def browse_matchmake_session_with_host_urls(self, search_criteria, range):
		logger.info(
			"MatchmakeExtensionClient.browse_matchmake_session_with_host_urls()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.add(search_criteria)
		...
		logger.info(
			"MatchmakeExtensionClient.browse_matchmake_session_with_host_urls -> done"
		)
		return obj
	...
	async def update_matchmake_session_attribute(self, gid, attribs):
		...
		logger.info(
			"MatchmakeExtensionClient.update_matchmake_session_attribute -> done"
		)
	...
	async def get_friend_notification_data_list(self, types):
		...
		logger.info(
			"MatchmakeExtensionClient.get_friend_notification_data_list -> done"
		)
		return notifications
	...
	async def auto_matchmake_with_search_criteria_postpone(
		...
		logger.info(
			"MatchmakeExtensionClient.auto_matchmake_with_search_criteria_postpone()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		...
		logger.info(
			"MatchmakeExtensionClient.auto_matchmake_with_search_criteria_postpone -> done"
		)
		return gathering
	...
	async def auto_matchmake_with_gathering_id_postpone(self, gids, gathering, message):
		logger.info(
			"MatchmakeExtensionClient.auto_matchmake_with_gathering_id_postpone()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.list(gids, stream.u32)
		...
		logger.info(
			"MatchmakeExtensionClient.auto_matchmake_with_gathering_id_postpone -> done"
		)
	...
	async def generate_matchmake_session_system_password(self, gid):
		logger.info(
			"MatchmakeExtensionClient.generate_matchmake_session_system_password()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.u32(gid)
		...
		logger.info(
			"MatchmakeExtensionClient.generate_matchmake_session_system_password -> done"
		)
		return password

	async def clear_matchmake_session_system_password(self, gid):
		logger.info(
			"MatchmakeExtensionClient.clear_matchmake_session_system_password()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.u32(gid)
		...
		logger.info(
			"MatchmakeExtensionClient.clear_matchmake_session_system_password -> done"
		)
	...
	async def create_matchmake_session_with_param(self, param):
		...
		logger.info(
			"MatchmakeExtensionClient.create_matchmake_session_with_param -> done"
		)
		return session
	...
	async def join_matchmake_session_with_param(self, param):
		...
		logger.info(
			"MatchmakeExtensionClient.join_matchmake_session_with_param -> done"
		)
		return session
	...
	async def auto_matchmake_with_param_postpone(self, param):
		...
		logger.info(
			"MatchmakeExtensionClient.auto_matchmake_with_param_postpone -> done"
		)
		return session

	async def find_matchmake_session_by_gathering_id_detail(self, gid):
		logger.info(
			"MatchmakeExtensionClient.find_matchmake_session_by_gathering_id_detail()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.u32(gid)
		...
		logger.info(
			"MatchmakeExtensionClient.find_matchmake_session_by_gathering_id_detail -> done"
		)
		return session
	...
	async def browse_matchmake_session_no_holder(self, search_criteria, range):
		...
		logger.info(
			"MatchmakeExtensionClient.browse_matchmake_session_no_holder -> done"
		)
		return sessions
	...
	async def browse_matchmake_session_with_host_urls_no_holder(
		...
		logger.info(
			"MatchmakeExtensionClient.browse_matchmake_session_with_host_urls_no_holder()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.add(search_criteria)
		...
		logger.info(
			"MatchmakeExtensionClient.browse_matchmake_session_with_host_urls_no_holder -> done"
		)
		return obj
	...
	async def find_matchmake_session_by_gathering_id(self, gids):
		...
		logger.info(
			"MatchmakeExtensionClient.find_matchmake_session_by_gathering_id -> done"
		)
		return sessions

	async def find_matchmake_session_by_single_gathering_id(self, gid):
		logger.info(
			"MatchmakeExtensionClient.find_matchmake_session_by_single_gathering_id()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.u32(gid)
		...
		logger.info(
			"MatchmakeExtensionClient.find_matchmake_session_by_single_gathering_id -> done"
		)
		return session
	...
	async def find_matchmake_session_by_participant(self, param):
		...
		logger.info(
			"MatchmakeExtensionClient.find_matchmake_session_by_participant -> done"
		)
		return result

	async def browse_matchmake_session_no_holder_no_result_range(self, search_criteria):
		logger.info(
			"MatchmakeExtensionClient.browse_matchmake_session_no_holder_no_result_range()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.add(search_criteria)
		...
		logger.info(
			"MatchmakeExtensionClient.browse_matchmake_session_no_holder_no_result_range -> done"
		)
		return sessions
	...
	async def browse_matchmake_session_with_host_urls_no_holder_no_result_range(
		...
		logger.info(
			"MatchmakeExtensionClient.browse_matchmake_session_with_host_urls_no_holder_no_result_range()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.add(search_criteria)
		...
		logger.info(
			"MatchmakeExtensionClient.browse_matchmake_session_with_host_urls_no_holder_no_result_range -> done"
		)
		return obj
...
class MatchmakeRefereeClient(MatchmakeRefereeProtocol):
	...
	async def end_round_with_partial_report(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_END_ROUND_WITH_PARTIAL_REPORT, stream.get()
		)
...
class MatchmakeExtensionServer(MatchmakeExtensionProtocol):
	...
	async def handle(self, client, method_id, input, output):
		if method_id in self.methods:
			...
			logger.warning(
				"Unknown method called on MatchmakeExtensionServer: %i", method_id
			)
			raise common.RMCError("Core::NotImplemented")
	...
	async def handle_browse_matchmake_session_with_host_urls(
		...
		logger.info(
			"MatchmakeExtensionServer.browse_matchmake_session_with_host_urls()"
		)
		# --- request ---
		search_criteria = input.extract(MatchmakeSessionSearchCriteria)
		range = input.extract(common.ResultRange)
	...
	async def handle_auto_matchmake_with_search_criteria_postpone(
		...
		logger.info(
			"MatchmakeExtensionServer.auto_matchmake_with_search_criteria_postpone()"
		)
		# --- request ---
	...
	async def handle_auto_matchmake_with_gathering_id_postpone(
		...
		logger.info(
			"MatchmakeExtensionServer.auto_matchmake_with_gathering_id_postpone()"
		)
		# --- request ---
		gids = input.list(input.u32)
		gathering = input.anydata()
	...
	async def handle_generate_matchmake_session_system_password(
		...
		logger.info(
			"MatchmakeExtensionServer.generate_matchmake_session_system_password()"
		)
		# --- request ---
		gid = input.u32()
	...
	async def handle_clear_matchmake_session_system_password(
		...
		logger.info(
			"MatchmakeExtensionServer.clear_matchmake_session_system_password()"
		)
		# --- request ---
		gid = input.u32()
	...
	async def handle_find_matchmake_session_by_gathering_id_detail(
		...
		logger.info(
			"MatchmakeExtensionServer.find_matchmake_session_by_gathering_id_detail()"
		)
		# --- request ---
		gid = input.u32()
	...
	async def handle_browse_matchmake_session_with_host_urls_no_holder(
		...
		logger.info(
			"MatchmakeExtensionServer.browse_matchmake_session_with_host_urls_no_holder()"
		)
		# --- request ---
		search_criteria = input.extract(MatchmakeSessionSearchCriteria)
		range = input.extract(common.ResultRange)
	...
	async def handle_find_matchmake_session_by_single_gathering_id(
		...
		logger.info(
			"MatchmakeExtensionServer.find_matchmake_session_by_single_gathering_id()"
		)
		# --- request ---
		gid = input.u32()
	...
	async def handle_browse_matchmake_session_no_holder_no_result_range(
		...
		logger.info(
			"MatchmakeExtensionServer.browse_matchmake_session_no_holder_no_result_range()"
		)
		# --- request ---
		search_criteria = input.extract(MatchmakeSessionSearchCriteria)
	...
	async def handle_browse_matchmake_session_with_host_urls_no_holder_no_result_range(
		...
		logger.info(
			"MatchmakeExtensionServer.browse_matchmake_session_with_host_urls_no_holder_no_result_range()"
		)
		# --- request ---
		search_criteria = input.extract(MatchmakeSessionSearchCriteria)
	...
	async def auto_matchmake_postpone(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.auto_matchmake_postpone not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def browse_matchmake_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.browse_matchmake_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def browse_matchmake_session_with_host_urls(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.browse_matchmake_session_with_host_urls not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def create_matchmake_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.create_matchmake_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def join_matchmake_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.join_matchmake_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def modify_current_game_attribute(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.modify_current_game_attribute not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_notification_data(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.update_notification_data not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_friend_notification_data(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.get_friend_notification_data not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_application_buffer(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.update_application_buffer not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_matchmake_session_attribute(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.update_matchmake_session_attribute not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_friend_notification_data_list(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.get_friend_notification_data_list not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_matchmake_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.update_matchmake_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def auto_matchmake_with_search_criteria_postpone(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.auto_matchmake_with_search_criteria_postpone not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def find_community_by_gathering_id(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.find_community_by_gathering_id not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_official_community(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.find_official_community not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_community_by_participant(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.find_community_by_participant not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_privacy_setting(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.update_privacy_setting not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def remove_from_block_list(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.remove_from_block_list not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def join_matchmake_session_ex(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.join_matchmake_session_ex not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_simple_playing_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.get_simple_playing_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def auto_matchmake_with_gathering_id_postpone(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.auto_matchmake_with_gathering_id_postpone not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def generate_matchmake_session_system_password(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.generate_matchmake_session_system_password not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def clear_matchmake_session_system_password(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.clear_matchmake_session_system_password not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def create_matchmake_session_with_param(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.create_matchmake_session_with_param not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def join_matchmake_session_with_param(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.join_matchmake_session_with_param not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def auto_matchmake_with_param_postpone(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.auto_matchmake_with_param_postpone not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_matchmake_session_by_gathering_id_detail(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.find_matchmake_session_by_gathering_id_detail not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def browse_matchmake_session_no_holder(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.browse_matchmake_session_no_holder not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def browse_matchmake_session_with_host_urls_no_holder(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.browse_matchmake_session_with_host_urls_no_holder not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_matchmake_session_part(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.update_matchmake_session_part not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def withdraw_matchmaking_all(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.withdraw_matchmaking_all not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_matchmake_session_by_gathering_id(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.find_matchmake_session_by_gathering_id not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_matchmake_session_by_single_gathering_id(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.find_matchmake_session_by_single_gathering_id not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_matchmake_session_by_owner(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.find_matchmake_session_by_owner not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_matchmake_session_by_participant(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.find_matchmake_session_by_participant not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def browse_matchmake_session_no_holder_no_result_range(self, *args):
		logger.warning(
			"MatchmakeExtensionServer.browse_matchmake_session_no_holder_no_result_range not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def browse_matchmake_session_with_host_urls_no_holder_no_result_range(
		...
		logger.warning(
			"MatchmakeExtensionServer.browse_matchmake_session_with_host_urls_no_holder_no_result_range not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
...
class MatchmakeRefereeServer(MatchmakeRefereeProtocol):
	...
	async def end_round_with_partial_report(self, *args):
		logger.warning(
			"MatchmakeRefereeServer.end_round_with_partial_report not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

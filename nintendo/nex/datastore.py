...
class DataStoreServer(DataStoreProtocol):
	...
	def handle_get_metas_multiple_param(self, input, output):
		...
		self.get_metas_multiple_param(response, params)

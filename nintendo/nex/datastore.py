...
class DataStoreServer(DataStoreProtocol):
	...
	async def get_new_arrived_notifications_v1(self, *args):
		logger.warning(
			"DataStoreServer.get_new_arrived_notifications_v1 not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def prepare_get_object_or_meta_binary(self, *args):
		logger.warning(
			"DataStoreServer.prepare_get_object_or_meta_binary not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def post_meta_binaries_with_data_id(self, *args):
		logger.warning(
			"DataStoreServer.post_meta_binaries_with_data_id not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

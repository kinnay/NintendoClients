...
class MatchmakeExtensionClientMHXX(MatchmakeExtensionProtocolMHXX):
	...
	async def browse_matchmake_session_with_host_urls(self, search_criteria, range):
		logger.info(
			"MatchmakeExtensionClientMHXX.browse_matchmake_session_with_host_urls()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.add(search_criteria)
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.browse_matchmake_session_with_host_urls -> done"
		)
		return obj
	...
	async def modify_current_game_attribute(self, gid, attrib, value):
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.modify_current_game_attribute -> done"
		)
	...
	async def update_matchmake_session_attribute(self, gid, attribs):
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.update_matchmake_session_attribute -> done"
		)
	...
	async def get_friend_notification_data_list(self, types):
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.get_friend_notification_data_list -> done"
		)
		return notifications
	...
	async def auto_matchmake_with_search_criteria_postpone(
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.auto_matchmake_with_search_criteria_postpone()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.auto_matchmake_with_search_criteria_postpone -> done"
		)
		return gathering
	...
	async def find_community_by_gathering_id(self, gids):
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.find_community_by_gathering_id -> done"
		)
		return communities
	...
	async def find_community_by_participant(self, pid, range):
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.find_community_by_participant -> done"
		)
		return communities
	...
	async def auto_matchmake_with_gathering_id_postpone(self, gids, gathering, message):
		logger.info(
			"MatchmakeExtensionClientMHXX.auto_matchmake_with_gathering_id_postpone()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.list(gids, stream.u32)
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.auto_matchmake_with_gathering_id_postpone -> done"
		)
	...
	async def generate_matchmake_session_system_password(self, gid):
		logger.info(
			"MatchmakeExtensionClientMHXX.generate_matchmake_session_system_password()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.u32(gid)
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.generate_matchmake_session_system_password -> done"
		)
		return password

	async def clear_matchmake_session_system_password(self, gid):
		logger.info(
			"MatchmakeExtensionClientMHXX.clear_matchmake_session_system_password()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.u32(gid)
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.clear_matchmake_session_system_password -> done"
		)

	async def create_matchmake_session_with_param(self, param):
		logger.info(
			"MatchmakeExtensionClientMHXX.create_matchmake_session_with_param()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.add(param)
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.create_matchmake_session_with_param -> done"
		)
		return session
	...
	async def join_matchmake_session_with_param(self, param):
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.join_matchmake_session_with_param -> done"
		)
		return session
	...
	async def auto_matchmake_with_param_postpone(self, param):
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.auto_matchmake_with_param_postpone -> done"
		)
		return session

	async def find_matchmake_session_by_gathering_id_detail(self, gid):
		logger.info(
			"MatchmakeExtensionClientMHXX.find_matchmake_session_by_gathering_id_detail()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.u32(gid)
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.find_matchmake_session_by_gathering_id_detail -> done"
		)
		return session
	...
	async def browse_matchmake_session_no_holder(self, search_criteria, range):
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.browse_matchmake_session_no_holder -> done"
		)
		return sessions
	...
	async def browse_matchmake_session_with_host_urls_no_holder(
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.browse_matchmake_session_with_host_urls_no_holder()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.add(search_criteria)
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.browse_matchmake_session_with_host_urls_no_holder -> done"
		)
		return obj
	...
	async def update_matchmake_session_part(self, param):
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.update_matchmake_session_part -> done"
		)
	...
	async def find_matchmake_session_by_gathering_id(self, gids):
		logger.info(
			"MatchmakeExtensionClientMHXX.find_matchmake_session_by_gathering_id()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.list(gids, stream.u32)
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.find_matchmake_session_by_gathering_id -> done"
		)
		return sessions

	async def find_matchmake_session_by_single_gathering_id(self, gid):
		logger.info(
			"MatchmakeExtensionClientMHXX.find_matchmake_session_by_single_gathering_id()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.u32(gid)
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.find_matchmake_session_by_single_gathering_id -> done"
		)
		return session
	...
	async def find_matchmake_session_by_owner(self, pid, range):
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.find_matchmake_session_by_owner -> done"
		)
		return sessions

	async def find_matchmake_session_by_participant(self, param):
		logger.info(
			"MatchmakeExtensionClientMHXX.find_matchmake_session_by_participant()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.add(param)
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.find_matchmake_session_by_participant -> done"
		)
		return result

	async def browse_matchmake_session_no_holder_no_result_range(self, search_criteria):
		logger.info(
			"MatchmakeExtensionClientMHXX.browse_matchmake_session_no_holder_no_result_range()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.add(search_criteria)
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.browse_matchmake_session_no_holder_no_result_range -> done"
		)
		return sessions
	...
	async def browse_matchmake_session_with_host_urls_no_holder_no_result_range(
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.browse_matchmake_session_with_host_urls_no_holder_no_result_range()"
		)
		# --- request ---
		stream = streams.StreamOut(self.settings)
		stream.add(search_criteria)
		...
		logger.info(
			"MatchmakeExtensionClientMHXX.browse_matchmake_session_with_host_urls_no_holder_no_result_range -> done"
		)
		return obj
	...
	async def update_friend_user_profile(self, param):
		...
		stream.add(param)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_UPDATE_FRIEND_USER_PROFILE, stream.get()
		)
	...
	async def get_friend_user_profiles(self, pids):
		...
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_FRIEND_USER_PROFILES, stream.get()
		)
	...
	async def get_friends(self):
		...
		stream = streams.StreamOut(self.settings)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_GET_FRIENDS, stream.get()
		)
	...
	async def add_friends(self, pids):
		...
		stream.list(pids, stream.u64)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_ADD_FRIENDS, stream.get()
		)
	...
	async def remove_friend(self, pid):
		...
		stream.u64(pid)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_REMOVE_FRIEND, stream.get()
		)
	...
	async def find_community_by_owner(self, id, range):
		...
		stream.add(range)
		data = await self.client.request(
			self.PROTOCOL_ID, self.METHOD_FIND_COMMUNITY_BY_OWNER, stream.get()
		)
...
class MatchmakeExtensionServerMHXX(MatchmakeExtensionProtocolMHXX):
	...
	async def handle(self, client, method_id, input, output):
		if method_id in self.methods:
			...
			logger.warning(
				"Unknown method called on MatchmakeExtensionServerMHXX: %i", method_id
			)
			raise common.RMCError("Core::NotImplemented")
	...
	async def handle_browse_matchmake_session_with_host_urls(
		...
		logger.info(
			"MatchmakeExtensionServerMHXX.browse_matchmake_session_with_host_urls()"
		)
		# --- request ---
		search_criteria = input.extract(MatchmakeSessionSearchCriteria)
		range = input.extract(common.ResultRange)
	...
	async def handle_auto_matchmake_with_search_criteria_postpone(
		...
		logger.info(
			"MatchmakeExtensionServerMHXX.auto_matchmake_with_search_criteria_postpone()"
		)
		# --- request ---
	...
	async def handle_auto_matchmake_with_gathering_id_postpone(
		...
		logger.info(
			"MatchmakeExtensionServerMHXX.auto_matchmake_with_gathering_id_postpone()"
		)
		# --- request ---
		gids = input.list(input.u32)
		gathering = input.anydata()
	...
	async def handle_generate_matchmake_session_system_password(
		...
		logger.info(
			"MatchmakeExtensionServerMHXX.generate_matchmake_session_system_password()"
		)
		# --- request ---
		gid = input.u32()
	...
	async def handle_clear_matchmake_session_system_password(
		...
		logger.info(
			"MatchmakeExtensionServerMHXX.clear_matchmake_session_system_password()"
		)
		# --- request ---
		gid = input.u32()
	...
	async def handle_create_matchmake_session_with_param(self, client, input, output):
		logger.info(
			"MatchmakeExtensionServerMHXX.create_matchmake_session_with_param()"
		)
		# --- request ---
	...
	async def handle_find_matchmake_session_by_gathering_id_detail(
		...
		logger.info(
			"MatchmakeExtensionServerMHXX.find_matchmake_session_by_gathering_id_detail()"
		)
		# --- request ---
		gid = input.u32()
	...
	async def handle_browse_matchmake_session_with_host_urls_no_holder(
		...
		logger.info(
			"MatchmakeExtensionServerMHXX.browse_matchmake_session_with_host_urls_no_holder()"
		)
		# --- request ---
		search_criteria = input.extract(MatchmakeSessionSearchCriteria)
		range = input.extract(common.ResultRange)
	...
	async def handle_find_matchmake_session_by_gathering_id(
		...
		logger.info(
			"MatchmakeExtensionServerMHXX.find_matchmake_session_by_gathering_id()"
		)
		# --- request ---
		gids = input.list(input.u32)
	...
	async def handle_find_matchmake_session_by_single_gathering_id(
		...
		logger.info(
			"MatchmakeExtensionServerMHXX.find_matchmake_session_by_single_gathering_id()"
		)
		# --- request ---
		gid = input.u32()
	...
	async def handle_find_matchmake_session_by_participant(self, client, input, output):
		logger.info(
			"MatchmakeExtensionServerMHXX.find_matchmake_session_by_participant()"
		)
		# --- request ---
	...
	async def handle_browse_matchmake_session_no_holder_no_result_range(
		...
		logger.info(
			"MatchmakeExtensionServerMHXX.browse_matchmake_session_no_holder_no_result_range()"
		)
		# --- request ---
		search_criteria = input.extract(MatchmakeSessionSearchCriteria)
	...
	async def handle_browse_matchmake_session_with_host_urls_no_holder_no_result_range(
		...
		logger.info(
			"MatchmakeExtensionServerMHXX.browse_matchmake_session_with_host_urls_no_holder_no_result_range()"
		)
		# --- request ---
		search_criteria = input.extract(MatchmakeSessionSearchCriteria)
	...
	async def close_participation(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.close_participation not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def open_participation(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.open_participation not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def auto_matchmake_postpone(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.auto_matchmake_postpone not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def browse_matchmake_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.browse_matchmake_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def browse_matchmake_session_with_host_urls(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.browse_matchmake_session_with_host_urls not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def create_matchmake_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.create_matchmake_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def join_matchmake_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.join_matchmake_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def modify_current_game_attribute(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.modify_current_game_attribute not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_notification_data(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.update_notification_data not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_friend_notification_data(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.get_friend_notification_data not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_application_buffer(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.update_application_buffer not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_matchmake_session_attribute(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.update_matchmake_session_attribute not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_friend_notification_data_list(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.get_friend_notification_data_list not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_matchmake_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.update_matchmake_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def auto_matchmake_with_search_criteria_postpone(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.auto_matchmake_with_search_criteria_postpone not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_playing_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.get_playing_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def find_community_by_gathering_id(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.find_community_by_gathering_id not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_official_community(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.find_official_community not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_community_by_participant(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.find_community_by_participant not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_privacy_setting(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.update_privacy_setting not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def remove_from_block_list(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.remove_from_block_list not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def clear_my_block_list(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.clear_my_block_list not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def join_matchmake_session_ex(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.join_matchmake_session_ex not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_simple_playing_session(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.get_simple_playing_session not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_simple_community(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.get_simple_community not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def auto_matchmake_with_gathering_id_postpone(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.auto_matchmake_with_gathering_id_postpone not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_progress_score(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.update_progress_score not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def debug_notify_event(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.debug_notify_event not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def generate_matchmake_session_system_password(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.generate_matchmake_session_system_password not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def clear_matchmake_session_system_password(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.clear_matchmake_session_system_password not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def create_matchmake_session_with_param(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.create_matchmake_session_with_param not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def join_matchmake_session_with_param(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.join_matchmake_session_with_param not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def auto_matchmake_with_param_postpone(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.auto_matchmake_with_param_postpone not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_matchmake_session_by_gathering_id_detail(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.find_matchmake_session_by_gathering_id_detail not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def browse_matchmake_session_no_holder(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.browse_matchmake_session_no_holder not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def browse_matchmake_session_with_host_urls_no_holder(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.browse_matchmake_session_with_host_urls_no_holder not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_matchmake_session_part(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.update_matchmake_session_part not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def request_matchmaking(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.request_matchmaking not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def withdraw_matchmaking(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.withdraw_matchmaking not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def withdraw_matchmaking_all(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.withdraw_matchmaking_all not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_matchmake_session_by_gathering_id(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.find_matchmake_session_by_gathering_id not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_matchmake_session_by_single_gathering_id(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.find_matchmake_session_by_single_gathering_id not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_matchmake_session_by_owner(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.find_matchmake_session_by_owner not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def find_matchmake_session_by_participant(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.find_matchmake_session_by_participant not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def browse_matchmake_session_no_holder_no_result_range(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.browse_matchmake_session_no_holder_no_result_range not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def browse_matchmake_session_with_host_urls_no_holder_no_result_range(
		...
		logger.warning(
			"MatchmakeExtensionServerMHXX.browse_matchmake_session_with_host_urls_no_holder_no_result_range not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def update_friend_user_profile(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.update_friend_user_profile not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

	async def get_friend_user_profiles(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.get_friend_user_profiles not implemented"
		)
		raise common.RMCError("Core::NotImplemented")
	...
	async def find_community_by_owner(self, *args):
		logger.warning(
			"MatchmakeExtensionServerMHXX.find_community_by_owner not implemented"
		)
		raise common.RMCError("Core::NotImplemented")

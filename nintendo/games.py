...
class Portal2:
	TITLE_ID = 0x0100ABD01785C000
	LATEST_VERSION = 0x20000
	
	GAME_SERVER_ID = 0x22306D00
	ACCESS_KEY = "hNWPC8B1"
	NEX_VERSION = 40606 #4.6.6
	CLIENT_VERSION = 2
